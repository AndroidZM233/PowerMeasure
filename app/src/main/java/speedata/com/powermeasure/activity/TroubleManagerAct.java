...
public class TroubleManagerAct extends FragActBase {
    @ViewById
            ...
            switch (msg.what){
                ...
                case Get_SPLIST_SUCCESS:
                    CommonAdapter commonAdapter=new CommonAdapter(mContext,special_list,
                            R.layout.adapter_troublemanager) {
                        @Override
    ...
    protected void main() {
        ...
        App.getInstance().addActivity(TroubleManagerAct.this);
        initTitlebar();
    ...
    private void DoGetSpecialList() {
        ...
        WebModel.getInstance().getSpecialList(new MResponseListener() {
            ...
            public void onSuccess(MResponse response) {
                ...
                callWebService="[{\"RT_F\":\"1\",\"RT_D\":\"\",\"SPECIAL_LIST\":[{\"ORDER_NO\":\"001楼链条线\",\"START_TIME\":\"2016-08-02 12：00\",\n" +
                        "\"END_TIME\":\"链条移动缓慢\",\"FILE_NAME\":\"123456\",\"FILE_PATH\":\"/home/app/\"}]}]";
